...
Nowadays, serial connections are easy and cheap. A terminal emulation program on your Windows, Mac, or Linux computer, and a cheap serial RS232-to-USB cable is all that is required. That means that serial input and output are today the preferred option for interfacing with your vintage KIM-1 or new-kids-on-the-block PAL-1. 
...
<img src="https://github.com/hjmegens/PAL1_tools/blob/main/program_sources/kimventure_docs/original_audio/diagnostic_figures/kimventure_specgram.png?raw=true" alt="fig1" style="width: 600px;"/>
